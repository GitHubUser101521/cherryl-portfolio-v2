        ...
        <div  className="flex flex-col gap-20 py-10">
            <div className="flex items-center justify-between">
                <div className="relative w-1/3">
                    <div className="border aspect-square rounded-full flex justify-center items-center relative">
                        <img src="/smiley-face.png" alt="Hi!" className="scale-125"/>
                    </div>

                    <div className="bg-slate-100 p-2 px-4 rounded-md absolute bottom-0 left-1/2 -translate-x-1/2 w-3/4 text-center">
                        Frond-end Developer
                    </div>
                </div>

                <div className="w-1/2">
                    <p className="italic">Nice to meet you, I'm</p>
                    <h1 className="text-gradient-yp">
                        Cherryl Callista 
                        <br />
                        <span className="text-gradient-yp">Cheniago</span>
                    </h1>
                    <p className="mt-8 text-xl">{`> Based in `}<span className="font-bold">Indonesia, Jakarta</span></p>
                </div>
            </div>
